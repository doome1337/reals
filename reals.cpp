...
int main(int argc, char** argv) {
        ...
        std::vector<cl_int> boolean_constants;
        boolean_constants.push_back(APPLY_GR_RS);
        boolean_constants.push_back(APPLY_INTENSITY);
        boolean_constants.push_back(APPLY_LENSING);
        boolean_constants.push_back(APPLY_SR_RS);
        boolean_constants.push_back(USE_ALTERNATE_FACTOR);
        boolean_constants.push_back(USE_INSTANT_GRAVITY);
        boolean_constants.push_back(USE_LONG_STEP);
